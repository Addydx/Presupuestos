...
class EditarProyectoScreen extends StatefulWidget {
  ...
  const EditarProyectoScreen({super.key, required this.proyecto});
...
class _EditarProyectoScreenState extends State<EditarProyectoScreen> {
  ...
  late final TextEditingController _nombreProyectoController;
  ...
  void initState() {
    ...
    _nombreProyectoController = TextEditingController(text: p.nombreProyecto);
    _nombreClienteController = TextEditingController(text: p.nombreCliente);
    ...
    _fechaInicioController = TextEditingController(
      text: p.fechaInicio != null
          ? '${p.fechaInicio!.day}/${p.fechaInicio!.month}/${p.fechaInicio!.year}'
          : '',
    );
    _fechaFinController = TextEditingController(
      text: p.fechaFin != null
          ? '${p.fechaFin!.day}/${p.fechaFin!.month}/${p.fechaFin!.year}'
          : '',
    );
    if (p.imagenPath != null && p.imagenPath!.isNotEmpty) {
      _imagenProyecto = File(p.imagenPath!);
    }
  }
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: _imagenProyecto == null
                          ? []
                          : [
                              BoxShadow(
                    ...
                    child: InkWell(
                      onTap: () {
                        if (_formKey.currentState!.validate()) {
                          ...
                          Navigator.pop(context, proyectoActualizado);
                        }
                      },
                      borderRadius: BorderRadius.circular(14),
                      child: Row(
